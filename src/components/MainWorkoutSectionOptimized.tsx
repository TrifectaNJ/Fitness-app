...
interface MainWorkoutSubsection {
  id: string;
...
interface MainWorkoutSectionOptimizedProps {
  workoutId: string;
  currentExerciseIndex: number;
  allExercises: Exercise[];
  onExerciseClick: (exercise: Exercise, subsection?: any) => void;
  subsections: MainWorkoutSubsection[];
  userId: string;
}

const MainWorkoutSectionOptimized: React.FC<MainWorkoutSectionOptimizedProps> = ({
  workoutId,
  ...
  const handleExerciseClick = (exercise: Exercise, subsection: MainWorkoutSubsection) => {
    onExerciseClick(exercise, subsection);
  };

  const handleExerciseToggle = async (exerciseId: string, subsection: MainWorkoutSubsection) => {
...
export default MainWorkoutSectionOptimized;